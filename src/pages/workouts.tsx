    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="container mx-auto p-4 space-y-6 pb-24">
        <div className="flex items-center justify-between pt-4">
          ...
          <Button className="bg-slate-700 hover:bg-slate-600 text-white border border-cyan-400/50 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-400/20">
        ...
        <Card className="bg-slate-800/80 border-slate-700/50 shadow-xl backdrop-blur-xl">
          <CardHeader>
            <CardTitle className="text-white">Workout Logger</CardTitle>
            <CardDescription className="text-slate-300">Track your exercises with RIR (Reps in Reserve)</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-slate-300">Start logging your first workout!</p>
          </CardContent>
        </Card>
      </div>
    </div>
