    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div className="container mx-auto p-4 space-y-8 pb-24">
        ...
        <div className="text-center pt-6 space-y-4">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Our Mission & Model</h1>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-slate-100/50 dark:bg-slate-700/30 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                    <p className="text-green-800 dark:text-green-200 font-medium">✓ Core Features Forever</p>
          ...
          <CardContent className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-slate-100/50 dark:bg-slate-700/30 rounded-lg">
                    <span className="text-slate-700 dark:text-slate-300">Server & Infrastructure</span>
                    <Badge variant="secondary" className="bg-slate-200 dark:bg-slate-600">~60%</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-slate-100/50 dark:bg-slate-700/30 rounded-lg">
                    <span className="text-slate-700 dark:text-slate-300">New Free Feature Development</span>
                    <Badge variant="secondary" className="bg-slate-200 dark:bg-slate-600">~30%</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-slate-100/50 dark:bg-slate-700/30 rounded-lg">
                    <span className="text-slate-700 dark:text-slate-300">Platform Maintenance</span>
                    <Badge variant="secondary" className="bg-slate-200 dark:bg-slate-600">~10%</Badge>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-pink-50 dark:bg-pink-900/20 rounded-lg border border-pink-200 dark:border-pink-800">
                    <p className="text-pink-800 dark:text-pink-200 font-medium">🎯 Charity Integration</p>
                  ...
                  <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                    <p className="text-amber-800 dark:text-amber-200 font-medium">🌟 Community Features</p>
